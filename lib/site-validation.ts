...
export const siteContentSchema = z
  .object({
    ...
    appearance: z.object({
      ...
      themePreset: z.enum(["juris", "graphite", "custom"]),
      themeCustomBackground: color,
      themeCustomSurface: color,
      themeCustomText: color,
      themeCustomAccent: color,
    ...
    products: z
      .array(
        z.object({
          ...
          accentColor: color,
          featured: z.boolean(),
          sellerBadge: z.boolean(),
          bestSellerBadge: z.boolean(),
          promotionBadge: z.boolean(),
          promotionPercent: z.number().int().min(1).max(99),
          isVisible: z.boolean(),
          sortOrder: z.number().int().min(0).max(9999),
        }),
      )
